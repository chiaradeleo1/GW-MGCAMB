    ...
    Type SourceTermParams
        ...
        logical :: gwlens_velocity = .false. !CDL
    ...
    Type TRedWin !internal type
        ...
        real(dl), dimension(:), allocatable :: winF, wing,wing2,wingtau,dwing,dwing2,dwingtau,ddwing,ddwing2,ddwingtau,&
            winISW, dwinISW, winTD, dwinTD, winGPhi, dwinGPhi, winD, dwinD, winLSD, dwinLSD, ddwinLSD, winV,dwinV,ddwinV, win_lens, comoving_density_ev, beta
